...
async function updateInfobar()
{
    ...
    $.each(flights, (idx, obj) => {
        if(patrons[obj.cid] && (patrons[obj.cid].tier >= 2 || !patrons[obj.cid].tier) && streamers[patrons[obj.cid].twitch])
        {
            ...
            html += '<tr><td class="py-2"><a class="footer-infobar-item text-white px-3 py-2" href="' + s.url + '"><i class="fab fa-twitch"></i> ' + s.streamername + '</a></td><td class="ps-3 footer-infobar-item px-3 py-2" onmouseup="zoomToFlight(\'' + s.uid + '\')">' + s.callsign + '</td><td class="ps-3">' + s.dep + '</td><td class="ps-2"><div class="d-flex flex-row align-items-center" style="width: 140px"><div id="infobar-flights-progressbar" class="d-flex flex-row align-items-center" style="flex-grow: 1"><div class="toggle-flights-progressbar-elapsed" id="' + s.uid + '" style="background-color: ' + flight_status.color + '; width: ' + getInfoElapsedWidth(infoflight) + '%"></div><i class="toggle-flights-progressbar-plane fas fa-plane" id="' + s.uid + '" style="color: ' + flight_status.color + '"></i><div class="toggle-flights-progressbar-remaining" id="' + s.uid + '"></div></td><td class="ps-2" style="text-align: right">' + s.arr + '</td></tr>';
        }
    })
